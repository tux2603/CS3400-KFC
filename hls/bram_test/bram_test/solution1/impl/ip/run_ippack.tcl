...
set Library     "hls"
set IPName      "mem_controller"
set Version     "1.0"
set DisplayName "Mem_controller"
set Revision    "2101192318"
...
set sdx_kernel_name "mem_controller"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/ooc/repos/kfc/hls/bram_test/bram_test/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {mem_controller_AXILiteS_s_axi
mem_controller
}
set kernel_xo ""

## Variables
set Top "mem_controller"
set TopNoPrefix "mem_controller"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 addr W 0x0 "Data signal of addr" {{0 8 addr W 0 "Bit 7 to 0 Data signal of addr"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 rw W 0x0 "Data signal of rw" {{0 8 rw W 0 "Bit 7 to 0 Data signal of rw"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 data_in W 0x0 "Data signal of data_in" {{0 32 data_in W 0 "Bit 31 to 0 Data signal of data_in"}}} {0x28 data_out R 0x0 "Data signal of data_out" {{0 32 data_out R 0 "Bit 31 to 0 Data signal of data_out"}}} {0x2c data_out_ctrl R 0x0 "Control signal of data_out" {{0 1 data_out_ap_vld R 0 "Control signal data_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
